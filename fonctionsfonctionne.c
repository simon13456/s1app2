...
int main()
{		
	char tableaucaractere[] = "Bonjour les amis";
	char caractere = 'a';
	printf("La position du caractere recherche est %d.\n", rechcaractere(caractere, tableaucaractere));
	
	char mot[] = "laval";
	printf("Est ce que le mot est un palindrome? %d\n", palindrome(mot));
	
	printf("La valeur du calcul de cosinus est de %f.", cosinus(2));
